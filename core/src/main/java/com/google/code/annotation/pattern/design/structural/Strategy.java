...
/**
 * @see <a href="http://c2.com/cgi/wiki?StrategyPattern">Strategy</a>
 *
...
@TargetDesignator( {
		@Constraint(role = "STRATEGY", condition = "interface(*)", bind = "S"),
		@Constraint(role = "CONCRETE_STRATEGY", condition = "class(!abstract *)", bind = "CS"),
...
public @interface Strategy {
	...
	public enum Role {
		STRATEGY, CONCRETE_STRATEGY, CONTEXT, CONTEXT_INTERFACE, ALGORITHM_INTERFACE;
	}
}
